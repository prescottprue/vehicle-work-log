...
function getStorageClient() {
  ...
  invariant(typeof MINIO_ACCESS_KEY === "string", "MINIO_ACCESS_KEY env var not set");
  invariant(typeof MINIO_SECRET_KEY === "string", "MINIO_SECRET_KEY env var not set");
...
export async function uploadFile(objectName: string, stream: string | Readable | Buffer, size?: number, metaData?: Minio.ItemBucketMetadata | undefined) {
