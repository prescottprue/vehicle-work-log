      ...
      <header className="sticky top-0 z-20 border-b border-line bg-card/95 backdrop-blur">
        <div className="mx-auto flex max-w-5xl items-center justify-between gap-3 px-4 py-3 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            <Link
              to="/ask"
              className="inline-flex min-h-11 items-center gap-1.5 rounded-full border border-line bg-card px-4 text-sm font-semibold text-ink-muted transition-colors hover:text-ink"
              activeProps={{ className: "text-ink border-accent" }}
            >
              <svg
                viewBox="0 0 24 24"
                className="h-4 w-4"
